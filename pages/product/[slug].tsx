  ...
  if (product) {
    const [ls] = await pool.query(
      `SELECT id, title, url, price, source
       FROM listings WHERE product_id = ? ORDER BY price IS NULL, price ASC, id ASC LIMIT 12`,
      [product.id]
    );
    listings = ls as any[];
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border rounded-2xl p-5 shadow-sm">
          ...
          <div className="flex flex-col">
            ...
            <p className="mt-4 text-gray-700">
              {product.description || 'This is dummy copy for an affiliate/e-commerce style detail page. Add your own long description, specs and badges here.'}
            </p>
