      ...
      <div className="mx-auto max-w-6xl space-y-8 px-6">
        <header className="space-y-2">
          ...
          <p className="text-sm text-gray-600">
            Ejecuta sincronizaciones manuales, revisa los checkpoints y audita
        ...
        {loadError && (
          <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4 text-sm text-yellow-800">
            ...
            <p className="mt-2 text-yellow-700">
              Verifica las variables de entorno de TiDB y que las tablas{" "}
              <code>sync_log</code> y <code>sync_checkpoint</code> existan. Se
              crearán automáticamente en el próximo intento si la conexión es
              exitosa.
            </p>
          </div>
        )}
